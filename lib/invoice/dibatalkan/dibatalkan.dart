...
class DiBatalkan extends StatefulWidget {
  DiBatalkan({Key key, @required this.idTransaksi, @required this.dataSn}) : super(key: key);
  final String idTransaksi;
  final DocumentSnapshot dataSn;
  @override
  _DBbatalkanState createState() => _DBbatalkanState();
}

class _DBbatalkanState extends State<DiBatalkan> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: new AppBar(title: const Text('Invoice'),
        backgroundColor: Color(0xFFDE282B),
      ),
      body: SlidingUpPanel(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Center(
              child: Container(
                height: 250.0,
                child: Image.asset('assets/images/dibatalkan.png'),
              ),
            ),
          ),
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text('TRANSAKSI DIBATALKAN', style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w700, color: Color(0xFFDE282B)),),
                )
              ],
            ),
          ),
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(widget.idTransaksi, style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w700, color: Color(0xFFDE282B)),),
              ],
            ),
          ),
        ],
...
class SpritePainter extends CustomPainter {
  ...
  void circle(Canvas canvas, Rect rect, double value) {
    ...
    Color color = Color(0xFFDE282B).withOpacity(opacity);
