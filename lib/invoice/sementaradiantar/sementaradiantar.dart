...
class SementaraDiantar extends StatefulWidget {
  SementaraDiantar({Key key, @required this.idTransaksi, @required this.dataSn}) : super(key: key);
  final String idTransaksi;
  final DocumentSnapshot dataSn;
  @override
  _SementaraDiantarState createState() => _SementaraDiantarState();
}

class _SementaraDiantarState extends State<SementaraDiantar> with SingleTickerProviderStateMixin {
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Center(
              child: Container(
                height: 250.0,
                child: Image.asset('assets/images/pengantaran.png'),
              ),
            ),
          ),
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text('MOHON TUNGGU,', textAlign: TextAlign.center, style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w700, color: CompanyColors.utama)),
                ),
                Padding(
                  padding: const EdgeInsets.only(bottom:330.0, top: 10.0),
                  child: Text('SEMENTARA DIANTARKAN', textAlign: TextAlign.center, style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w700, color: CompanyColors.utama),),
                )
              ],
            ),
          ),
