...
class DalamProses extends StatefulWidget {
  DalamProses({Key key, @required this.idTransaksi, @required this.dataSn}) : super(key: key);
  final String idTransaksi;
  final DocumentSnapshot dataSn;
  @override
  _DalamProsesState createState() => _DalamProsesState();
}

class _DalamProsesState extends State<DalamProses> with SingleTickerProviderStateMixin {
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Center(
              child: Container(
                height: 250.0,
                child: Image.asset('assets/images/dalam_proses.png'),
              ),
            ),
          ),
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text('PESANAN KAMU SEMENTARA DIPROSES', style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w700, color: CompanyColors.utama),),
                )
              ],
            ),
          ),
