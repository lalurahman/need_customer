  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        ...
        Container(
          width: MediaQuery.of(context).size.width,
          padding: EdgeInsets.only(left: 15.0, top: .0, right: 10.0, bottom: 10.0),
          // height: 160.0,
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    wdg('LAINNYA', 'assets/images/lainnya.png', (){
                      Navigator.push(
                        context,
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                margin: EdgeInsets.only(top: 10.0, bottom: 2.0, left: 3.0, right: 3.0),
